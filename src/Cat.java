...
public class Cat {
	...
	private static final int HEAD_DIMENSION = 175;
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		g2.drawString("I am a cat", catX, catY+HEAD_DIMENSION+10);	
		g2.drawString("MEOWWWWWWWWWWWWWWWWWWWWWW", catX, catY+HEAD_DIMENSION+20);	
